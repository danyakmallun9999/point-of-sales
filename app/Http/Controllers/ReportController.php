...
class ReportController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        $shifts = \App\Models\CashierShift::with(['user', 'outlet'])
            ->whereBetween('created_at', [$startDate.' 00:00:00', $endDate.' 23:59:59'])
            ->latest()
            ->get();
     ...
     */
    public function printReport(Request $request): \Illuminate\Contracts\View\View
    {
        $startDate = $request->input('start_date', now()->startOfMonth()->toDateString());
        $endDate = $request->input('end_date', now()->toDateString());
        ...
        return view('print.reports-summary', compact('summary', 'topProducts', 'dailySales', 'shifts', 'startDate', 'endDate'));
    }
